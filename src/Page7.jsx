...
const Page7 = () => {
  ...
  return (
    <div className="page7 project-component h-screen w-full bg-[#F7F7EE] relative overflow-hidden py-10">
      <div className="h-full w-full sticky flex items-center justify-between">
      <div
        className="leftSide h-[100%] w-[46%] overflow-hidden rounded-r-3xl"
      >
        <img
          loading="lazy"
      ...
      <div className="center absolute top-0 left-[35%] h-[100%] w-[30%] flex flex-col items-center justify-center gap-12">
        <h1 className="font-PP-Woodland text-7xl text-center text-[#434b34]">
          Relaxing treatments
        </h1>
        <p className="font-DM-Sans text-[#5b6647] text-center leading-5 ">
          Massage, sauna sessions, beauty treatments such as pedicures and
          manicures, a fitness room, an outdoor children's pool filled with sea
          water or a sun terrace to relax on.
        </p>
      ...
      <div
        className="rightSide h-[100%] w-[46%] overflow-hidden rounded-l-3xl"
      >
        <img
          loading="lazy"
          className="h-full w-full object-cover object-center"
